    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->encryptData, &QPushButton::clicked, this, &MainWindow::encryptData);
...
void MainWindow::uploadFile() {
    ...
    // 加载 Haar 级联分类器(根据自己的haarcascades文件路径进行修改)
    cv::CascadeClassifier faceDetector("/usr/share/opencv4/haarcascades/haarcascade_frontalface_default.xml");
...
void MainWindow::encryptData()
{
    QtConcurrent::run([this]() {
        QString filePath = "/home/flutter/Work/Encryption/build/trainer.yml";
        QFile file(filePath);
